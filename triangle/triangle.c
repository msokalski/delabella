...
/*  jrs@cs.berkeley.edu                                                      */
/*                                                                           */
/*  Modifoed by GUMIX for 64bit arch support                                 */
/*  - all pointers passed to printf use %p, no cast (was x%lu, unsigned long)*/
/*  - all bit manipulations on pointers use uintptr_t (was unsigned long)    */
/*                                                                           */
...

{
  ...
  return incircleadapt((vertex)pa, (vertex)pb, (vertex)pc, (vertex)pd, permanent);
}
